...
SESSION_COOKIE_DOMAIN = ".replantworld.io"
CSRF_COOKIE_DOMAIN = ".replantworld.io"
...
MIDDLEWARE = [
    ...
    "replant.middleware.TimeZoneMiddleware",
    "replant.request_middleware.request_info.RequestResponseMiddleware"
]
