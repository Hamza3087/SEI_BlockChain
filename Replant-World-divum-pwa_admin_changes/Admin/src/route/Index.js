...
import PeopleOrganization from '../pages/PeopleOrganization';
  ...
  return (
      <Routes>
        ...
        <Route path={`${process.env.PUBLIC_URL}`} element={<Layout />}>
          ...
          <Route path='people-organization' element={<PeopleOrganization />}></Route>
          <Route path='nft-history' element={<NftHistory />}></Route>
